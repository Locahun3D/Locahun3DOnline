...
const SALE_PRICE_PRESETS = [
  0, 50000, 100000, 150000, 200000, 250000, 300000, 400000, 500000, 800000, 1200000,
] as const;
      ...
      {DATA_LICENSES.map((license) => {
        ...
        return (
          <div key={license} className="flex flex-wrap items-start gap-3 border-b border-line/30 pb-2.5 last:border-0 last:pb-0">
            <label className="flex items-start gap-2.5 min-w-[240px] flex-1 cursor-pointer">
              <input
                type="checkbox"
                checked={!!opt}
            ...
            {opt && license === "editorial" ? (
              <div className="text-right text-[12px]">
                <span className="mono">無料</span>
                <p className="text-[11px] text-muted">エディトリアルは常に無料（固定）</p>
              </div>
