...
const ja = {
  ...
  "plan.ind.desc": "個人クリエイター向け。月 24 トークンで案件 6-9 件分のロケハンに。",
  "plan.ind.f1": "3DGS ウォークスルー 月 24 トークン",
  ...
  "plan.studio.desc": "小規模制作チーム向け。月 36 トークン + 5 端末共有。単発撮影でも余裕。",
  "plan.studio.f1": "Individual の全機能",
  "plan.studio.f2": "3DGS ウォークスルー 月 36 トークン",
  "plan.studio.f3": "5 端末まで同時ログイン",
  "plan.studio.f4": "チーム履歴の共有",
  "plan.studio.f5": "請求書を毎月自動送付 (電子帳簿対応)",
  "plan.team.desc": "プロダクション向け。月 90 トークン + 20 端末 + 請求書対応。",
  "plan.team.f1": "Studio の全機能",
  "plan.team.f2": "3DGS ウォークスルー 月 90 トークン",
...
const en: Record<keyof typeof ja, string> = {
  ...
  "plan.ind.desc":
    "For individual creators. 24 tokens/month — enough scouting for 6–9 projects.",
  "plan.ind.f1": "3DGS walkthrough — 24 tokens / month",
  ...
  "plan.studio.desc":
    "For small production teams. 36 tokens/month + 5 shared devices — ample even for one-off shoots.",
  "plan.studio.f1": "Everything in Individual",
  "plan.studio.f2": "3DGS walkthrough — 36 tokens / month",
  ...
  "plan.team.desc":
    "For production companies. 90 tokens/month + 20 devices + invoice billing.",
  "plan.team.f1": "Everything in Studio",
  "plan.team.f2": "3DGS walkthrough — 90 tokens / month",
