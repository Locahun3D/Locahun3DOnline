...
const ja = {
  ...
  "plan.studio.desc": "小規模制作チーム向け。月 24 トークン + 10 端末共有。単発撮影でも余裕。",
  ...
  "plan.team.desc": "プロダクション向け。月 60 トークン + 30 端末 + 請求書対応。",
...
const en: Record<keyof typeof ja, string> = {
  ...
  "plan.studio.desc":
    "For small production teams. 24 tokens/month + 10 shared devices — ample even for one-off shoots.",
  ...
  "plan.team.desc":
    "For production companies. 60 tokens/month + 30 devices + invoice billing.",
