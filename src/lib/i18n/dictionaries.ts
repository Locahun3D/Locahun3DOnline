...
const ja = {
  ...
  "plan.free.desc": "登録だけで OK。アカウント作成時 1 トークン付与でハウススタジオを試せる。",
  "plan.free.f1": "全物件のサムネイル・写真閲覧",
  "plan.free.f2": "地図・フィルタ・距離検索",
  "plan.free.f3": "見積もり依頼 月 1 件まで",
  "plan.free.f4": "3DGS ウォークスルー 登録時 1 トークン (一度限り)",
  "plan.ind.desc": "個人クリエイター向け。月 8 トークンで案件 2-3 件分のロケハンに。",
  "plan.ind.f1": "3DGS ウォークスルー 月 8 トークン",
  ...
  "plan.studio.desc": "小規模制作チーム向け。月 12 トークン + 5 端末共有。単発撮影でも余裕。",
  "plan.studio.f1": "Individual の全機能",
  "plan.studio.f2": "3DGS ウォークスルー 月 12 トークン",
  "plan.studio.f3": "5 端末まで同時ログイン",
  "plan.studio.f4": "チーム履歴の共有",
  "plan.studio.f5": "請求書を毎月自動送付 (電子帳簿対応)",
  "plan.team.desc": "プロダクション向け。月 30 トークン + 20 端末 + 請求書対応。",
  "plan.team.f1": "Studio の全機能",
  "plan.team.f2": "3DGS ウォークスルー 月 30 トークン",
...
const en: Record<keyof typeof ja, string> = {
  ...
  "plan.free.desc":
    "Just sign up. You get 1 token on account creation to try a house studio.",
  ...
  "plan.free.f4": "3DGS walkthrough — 1 token at signup (one-time)",
  "plan.ind.desc":
    "For individual creators. 8 tokens/month — enough scouting for 2–3 projects.",
  "plan.ind.f1": "3DGS walkthrough — 8 tokens / month",
  ...
  "plan.studio.desc":
    "For small production teams. 12 tokens/month + 5 shared devices — ample even for one-off shoots.",
  "plan.studio.f1": "Everything in Individual",
  "plan.studio.f2": "3DGS walkthrough — 12 tokens / month",
  ...
  "plan.team.desc":
    "For production companies. 30 tokens/month + 20 devices + invoice billing.",
  "plan.team.f1": "Everything in Studio",
  "plan.team.f2": "3DGS walkthrough — 30 tokens / month",
