...
export async function generateMetadata() {
  ...
  return {
    title: locale === "en" ? "Listing Data Revenue Share Terms" : "掲載データ販売分配規約｜ロケハン3D",
  };
}
  ...
  return (
    <div className="theme-online w-full max-w-3xl mx-auto px-6 ui-page-shell pb-12 sm:pb-32">
      ...
      <div className="prose-terms space-y-10 text-[14px] leading-[1.85]">
        <section>
          <h2 className="ui-section-title mb-4">第1条（適用対象）</h2>
        ...
        <section>
          <h2 className="ui-section-title mb-4">第5条（非独占）</h2>
          <p className="opacity-80">
        ...
        <section>
          <h2 className="ui-section-title mb-4">第6条（本サービス利用規約との関係）</h2>
          <p className="opacity-80">
        ...
        <section>
          <h2 className="ui-section-title mb-4">第7条（規約の変更）</h2>
          <p className="opacity-80">
        ...
        <section>
          <h2 className="ui-section-title mb-4">第8条（準拠法・管轄裁判所）</h2>
          <p className="opacity-80">
  ...
  return (
    <div className="theme-online w-full max-w-3xl mx-auto px-6 ui-page-shell pb-12 sm:pb-32">
      ...
      <div className="prose-terms space-y-10 text-[14px] leading-[1.85]">
        ...
        <section>
          <h2 className="ui-section-title mb-4">Article 5 (Non-exclusive)</h2>
          <p className="opacity-80">
        ...
        <section>
          <h2 className="ui-section-title mb-4">Article 6 (Relationship to the Terms of Service)</h2>
          <p className="opacity-80">
        ...
        <section>
          <h2 className="ui-section-title mb-4">Article 7 (Changes to these terms)</h2>
          <p className="opacity-80">
        ...
        <section>
          <h2 className="ui-section-title mb-4">Article 8 (Governing law &amp; jurisdiction)</h2>
          <p className="opacity-80">
