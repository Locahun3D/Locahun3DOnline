      ...
      <div className="prose-terms space-y-10 text-[14px] leading-[1.85]">
        ...
        <section>
          ...
          <ol className="list-decimal pl-6 space-y-2 opacity-80">
            ...
            <li>掲示板・レビュー機能への虚偽の投稿、誹謗中傷、スパム行為、または通報機能を悪用する行為</li>
        ...
        <section>
          ...
          <p className="opacity-80">
            本サービスに関する著作権・商標権その他の知的財産権は、当社または正当な権利を有する第三者に帰属します。利用者が投稿した掲示板・レビューの著作権は投稿者に留保されますが、利用者は当社に対し、本サービスの提供・運営・宣伝に必要な範囲で当該投稿を利用（複製・表示等）する権利を許諾するものとします。
          </p>
        </section>

        <section>
          <h2 className="serif text-lg mb-4">第6条（投稿コンテンツの管理）</h2>
          <p className="opacity-80">
        ...
        <section>
          <h2 className="serif text-lg mb-4">第7条（サービスの停止・変更）</h2>
          <p className="opacity-80">
        ...
        <section>
          <h2 className="serif text-lg mb-4">第8条（利用制限・登録抹消）</h2>
          <p className="opacity-80">
        ...
        <section>
          <h2 className="serif text-lg mb-4">第9条（免責事項）</h2>
          <ol className="list-decimal pl-6 space-y-2 opacity-80">
        ...
        <section>
          <h2 className="serif text-lg mb-4">第10条（規約の変更）</h2>
          <p className="opacity-80">
        ...
        <section>
          <h2 className="serif text-lg mb-4">第11条（準拠法・管轄裁判所）</h2>
          <p className="opacity-80">
  ...
  return (
    <div className="theme-online max-w-3xl mx-auto px-6 pt-12 pb-12 sm:pb-32">
      ...
      <div className="prose-terms space-y-10 text-[14px] leading-[1.85]">
        ...
        <section>
          <h2 className="serif text-lg mb-4">Article 6 (Content Moderation)</h2>
          <p className="opacity-80">
        ...
        <section>
          <h2 className="serif text-lg mb-4">Article 7 (Suspension &amp; Changes)</h2>
          <p className="opacity-80">
        ...
        <section>
          <h2 className="serif text-lg mb-4">Article 8 (Restriction &amp; Termination)</h2>
          <p className="opacity-80">
        ...
        <section>
          <h2 className="serif text-lg mb-4">Article 9 (Disclaimer)</h2>
          <ol className="list-decimal pl-6 space-y-2 opacity-80">
        ...
        <section>
          <h2 className="serif text-lg mb-4">Article 10 (Changes to these Terms)</h2>
          <p className="opacity-80">
        ...
        <section>
          <h2 className="serif text-lg mb-4">Article 11 (Governing Law &amp; Jurisdiction)</h2>
          <p className="opacity-80">
