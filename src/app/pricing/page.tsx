...
const COMPARE_ROWS: Array<{
  ...
  { label: ["3DGS ウォークスルー", "3DGS walkthrough"], free: ["登録時 6 トークン", "6 tokens at signup"], individual: ["月 16 トークン", "16 tokens / mo"], studio: ["月 32 トークン", "32 tokens / mo"], team: ["月 90 トークン", "90 tokens / mo"] },
