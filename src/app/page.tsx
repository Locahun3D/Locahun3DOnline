...
export default function HomePage() {
  return (
    <>
      ...
      <section className="relative grid md:grid-cols-2 border-b border-line min-h-[90vh] overflow-hidden bg-bg">
        {/* Timecode corners */}
        ...
        <a
          ...
          target="_blank"
          rel="noopener"
          className="group relative flex flex-col justify-center items-center text-center px-8 lg:px-16 pt-48 pb-28 border-b md:border-b-0 md:border-r border-line hover:bg-[#0c0a07] transition-colors overflow-hidden"
        >
          <span className="leader text-[42vw] md:text-[22vw] serif">1</span>
          <div className="relative z-10 flex flex-col items-center">
            <div className="mono text-[10px] tracking-[0.45em] text-muted opacity-50 mb-5 whitespace-nowrap">
              L · O · C · A · H · U · N&nbsp;&nbsp;&nbsp;3&nbsp;D
            </div>
            <ScanMark size={42} className="mb-6" />
            ...
            <span className="mt-8 inline-flex items-center gap-2 mono text-[11px] tracking-[0.24em] uppercase text-accent transition-colors">
              スキャンを見る
        ...
        <Link
          href="/properties"
          className="group relative flex flex-col justify-center items-center text-center px-8 lg:px-16 pt-48 pb-28 hover:bg-[#070b0f] transition-colors overflow-hidden"
        >
          <span className="leader text-[42vw] md:text-[22vw] serif">2</span>
          <div className="relative z-10 flex flex-col items-center">
            <div className="mono text-[10px] tracking-[0.45em] text-muted opacity-50 mb-5 whitespace-nowrap">
              L · O · C · A · H · U · N&nbsp;&nbsp;&nbsp;3&nbsp;D
            </div>
            <ScanMark size={42} reticle="#5ec8e8" className="mb-6" />
            <div className="brand flex items-center justify-center gap-4 text-[clamp(0.85rem,1.2vw,1.05rem)] tracking-[0.28em] text-ink/85 mb-5">
              <span className="w-9 h-px bg-current opacity-50" />
              ロケハン3D
              <span className="w-9 h-px bg-current opacity-50" />
            ...
            <span className="mt-8 inline-flex items-center gap-2 mono text-[11px] tracking-[0.24em] uppercase text-[#5ec8e8]">
              オンラインを見る
              <span className="group-hover:translate-x-1 transition-transform">→</span>
            </span>
          </div>
